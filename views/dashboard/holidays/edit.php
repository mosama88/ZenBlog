...
<head>
    ...
    <title>Osama News | تعديل الأجازات الرسمية</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">تعديل الأجازه الرسمية</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a
                                        href="<?php echo URL . "views/dashboard/holidays/index.php" ?>">جدول
                                    الأجازات الرسمية</a></li>
                            <li class="breadcrumb-item active"> تعديل الأجازه الرسمية</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="col-10 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-9">
                                    <h5 class=""> تعديل الأجازه الرسمية</h5>
                                </div>
                            </div>
                        </div>
