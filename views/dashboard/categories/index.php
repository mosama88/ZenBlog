                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo URL . "views/dashboard/index.php"?>">لوحة التحكم</a></li>
...
<!-- </div>-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a type="button"  data-toggle="modal"
                                                   data-target="#EditmodalCategory" href="<?php echo URL . "handlers/edit-categories.php?id=" . $row['id'];?>" class="btn btn-small btn-info btn-sm text-white">تعديل</a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?php echo URL."handlers/store-categories.php"?>" role="form">
                                    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?php echo URL."handlers/edit-categories.php?id=" . $rowGet['id'] ?>" role="form">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputCategory">أسم الفئة</label>
    ...
    <script>
    $("#modal-primary,#Editmodal-primary").modal({
